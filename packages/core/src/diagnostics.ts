...
export const DIAGNOSTIC_CODES = Object.freeze({
  ...
  QR_INTERNAL_FORMAT: 'PULSE_QR_INVALID_INTERNAL_FORMAT',
  QR_SECTION_LIMIT: 'PULSE_QR_SECTION_LIMIT',
  QR_INTENSITY: 'PULSE_QR_UNREPRESENTABLE_INTENSITY',
  QR_FIRST_SECTION_DISABLED: 'PULSE_QR_FIRST_SECTION_DISABLED',
...
> = Object.freeze({
  ...
  [DIAGNOSTIC_CODES.QR_INTERNAL_FORMAT]: { stage: 'qr', defaultSeverity: 'error' },
  [DIAGNOSTIC_CODES.QR_SECTION_LIMIT]: { stage: 'qr', defaultSeverity: 'error' },
  [DIAGNOSTIC_CODES.QR_INTENSITY]: { stage: 'qr', defaultSeverity: 'error' },
  [DIAGNOSTIC_CODES.QR_FIRST_SECTION_DISABLED]: { stage: 'qr', defaultSeverity: 'error' },
