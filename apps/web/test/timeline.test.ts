...
describe('timeline point lookup', () => {
  it('uses the original stream and resolves boundaries and ties deterministically', () => {
  ...
  it('maps pointer coordinates to a clamped logical time', () => {
